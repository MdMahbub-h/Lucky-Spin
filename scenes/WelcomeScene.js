...
class WelcomeScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("start-bg", "/public/assets/spin1/start-bg.jpg");
    this.load.image("game-bg", "/public/assets/spin1/game-bg.jpg");
    this.load.image("option-box", "/public/assets/spin1/option-box.png");
    this.load.image("manu-box", "/public/assets/spin1/manu-box.png");
    ...
    this.load.image("icon", "/public/assets/icon.png");
    this.load.image("wheel", "/public/assets/spin1/wheel.png");
    this.load.spritesheet(
      "wheel-cover",
      "/public/assets/spin1/wheel-cover.png",
      {
        frameWidth: 998,
        frameHeight: 1216,
      }
    ...
    this.load.image("middle-circle", "/public/assets/spin1/middle-circle.png");
    this.load.image("pin", "/public/assets/spin1/pin.png");
